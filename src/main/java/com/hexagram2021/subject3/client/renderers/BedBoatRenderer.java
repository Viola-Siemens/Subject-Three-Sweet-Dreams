...
import com.hexagram2021.subject3.client.renderers.layout.BedBoatBedLayer;
...
public class BedBoatRenderer extends EntityRenderer<BedBoatEntity> implements IEntityRenderer<BedBoatEntity, BedBoatModel> {
	...
	protected final LayerRenderer<BedBoatEntity, BedBoatModel> bedLayer = new BedBoatBedLayer(this);
	...
	public void render(BedBoatEntity bedBoatEntity, float y, float ticks, MatrixStack transform, @Nonnull IRenderTypeBuffer buffer, int h) {
		...
		this.bedLayer.render(transform, buffer, h, bedBoatEntity, ticks, 0.0F, ticks, -0.1F, 0.0F, 0.0F);
