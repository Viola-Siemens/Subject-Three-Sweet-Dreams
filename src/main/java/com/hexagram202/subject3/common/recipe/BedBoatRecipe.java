...
public class BedBoatRecipe extends ShapelessOreRecipe {
    public BedBoatRecipe() {
        super(new ResourceLocation("subject3", "bed_boat_recipe"), new ItemStack(Subject3.ITEM_BOAT),
                Ingredient.fromItem(Items.BED), Ingredient.fromItems(Items.BOAT, Items.ACACIA_BOAT, Items.BIRCH_BOAT, Items.DARK_OAK_BOAT, Items.JUNGLE_BOAT, Items.SPRUCE_BOAT));
    }
